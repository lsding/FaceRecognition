...
def parse_args():
    ...
    parser.add_argument('--dface_traindata_store', dest='traindata_store', help='dface train data temporary folder,include 12,24,48/postive,negative,part,landmark',
                        default='/web2/ding/face/WIDER_train/', type=str)
...
if __name__ == '__main__':
    ...
    # gen_rnet_sample_data(args.traindata_store, args.annotation_file, '/home/ding/code/face/model_store/detections_1575276527.pkl', args.prefix_path)
