    ...
    for cur_epoch in range(1,end_epoch+1):
        ...
        for batch_idx,(image,(gt_label,gt_bbox,gt_landmark))in enumerate(train_data):
            ...
            if batch_idx%frequent==0:
                ...
                print("%s : Epoch: %d, Step: %d, accuracy: %.4f, det loss: %.4f, bbox loss: %.4f, all_loss: %.4f, lr:%s "%(datetime.datetime.now(),cur_epoch,batch_idx, show1,show2,show3,show5,base_lr))
